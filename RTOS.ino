...
void setup()
{
    ...
    xTaskCreate(buttonPress, "SW1", 128, dataPack + 0, 1, nullptr);
    xTaskCreate(buttonPress, "SW2", 128, dataPack + 1, 1, nullptr);
    xTaskCreate(buttonPress, "SW3", 128, dataPack + 2, 1, nullptr);
